...
UPDATE power_line
	SET
	voltage_array [1] = 220000 WHERE voltage_array[1] > 165000 AND voltage_array[1] < 300000;
UPDATE power_line
	SET
	voltage_array [1] = 380000 WHERE voltage_array[1] >= 300000;
UPDATE power_line
	SET
	voltage_array [2] = 110000 WHERE voltage_array[2] >= 60000 AND voltage_array[2] <= 165000;
UPDATE power_line
	SET
	voltage_array [2] = 220000 WHERE voltage_array[2] > 165000 AND voltage_array[2] < 300000;
UPDATE power_line
	SET
	voltage_array [2] = 380000 WHERE voltage_array[2] >= 300000;
UPDATE power_line
	SET
	voltage_array [3] = 110000 WHERE voltage_array[3] >= 60000 AND voltage_array[3] <= 165000;
UPDATE power_line
	SET
	voltage_array [3] = 220000 WHERE voltage_array[3] > 165000 AND voltage_array[3] < 300000;
UPDATE power_line
	SET
	voltage_array [3] = 380000 WHERE voltage_array[3] >= 300000;
UPDATE power_line
	SET
	voltage_array [4] = 110000 WHERE voltage_array[4] >= 60000 AND voltage_array[4] <= 165000;
UPDATE power_line
	SET
	voltage_array [4] = 220000 WHERE voltage_array[4] > 165000 AND voltage_array[4] < 300000;
UPDATE power_line
	SET
	voltage_array [4] = 380000 WHERE voltage_array[4] >= 300000;
...
UPDATE power_circuits
	SET voltage = 110000 WHERE voltage >= 60000 AND voltage <= 165000;
UPDATE power_circuits
	SET voltage = 220000 WHERE voltage > 165000 AND voltage < 300000;
UPDATE power_circuits
	SET voltage = 380000 WHERE voltage >= 300000;
...
-- add column connected_via that specifies, if line is normal=0 or was build to connect transfer-busses (1)/(2) or subgrids (3)
ALTER TABLE branch_data ADD COLUMN connected_via INT;
UPDATE branch_data
	SET connected_via = 0;
